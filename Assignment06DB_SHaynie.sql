...
-- 2017-01-01,SHaynie,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_SHaynie')
	 Begin 
	  Alter Database [Assignment06DB_SHaynie] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_SHaynie;
	 End
	Create Database Assignment06DB_SHaynie;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_SHaynie;
